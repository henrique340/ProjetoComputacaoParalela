...
#define MAX_THREADS 4  // Limitando o número de threads a 4
...
Result computePaths(Node* tree, int idx) {
    ...
    // Criação das threads, mas limitando o número de threads a MAX_THREADS
    ...
    // Se ainda houver filhos restantes que não foram processados por threads
